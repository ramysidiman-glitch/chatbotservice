"""
Django settings for OurChat(1) project.
...
SECRET_KEY = 'django-insecure-4$q8er3rnga6=#t_a2fzusgvkt%%k0!i4u5v1bgr7s)20b4@@j'
...
STATIC_URL = '/static/'  # déjà présent normalement
...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,chatbotservice-8rvb.onrender.com").split(",")
